...
REM Global config
REM -------------------------------------------------------------------
set PARADOX_SOLUTION=Paradox.Android.sln
set PARADOX_PLATFORM=Configuration=Release;Platform=Android
set PARADOX_BUILD_LOG=%~n0.log
set PARADOX_OUTPUT_DIR=%~dp0\Bin\Android-AnyCPU-OpenGLES
REM -------------------------------------------------------------------
REM Build Paradox
REM -------------------------------------------------------------------
