...
namespace CustomAnimationTest
{
    [TestFixture]
    public class CustomAnimationTest
    {
        private const string Path = "samples\\Others\\CustomAnimation\\Bin\\Windows\\Debug\\CustomAnimation.exe";
