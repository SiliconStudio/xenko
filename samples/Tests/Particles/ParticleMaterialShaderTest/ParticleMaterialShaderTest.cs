...
namespace ParticleMaterialShaderTest
{
    [TestFixture]
    public class ParticleMaterialShaderTest
    {
        private const string Path = "samples\\Particles\\ParticleMaterialShader\\Bin\\Windows\\Debug\\ParticleMaterialShader.exe";
