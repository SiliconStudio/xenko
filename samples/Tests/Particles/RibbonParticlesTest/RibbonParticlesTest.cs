...
namespace RibbonParticlesTest
{
    [TestFixture]
    public class RibbonParticlesTest
    {
        private const string Path = "samples\\Particles\\RibbonParticles\\Bin\\Windows\\Debug\\RibbonParticles.exe";
