...
namespace ChildParticlesTest
{
    [TestFixture]
    public class ChildParticlesTest
    {
        private const string Path = "samples\\Particles\\ChildParticles\\Bin\\Windows\\Debug\\ChildParticles.exe";
