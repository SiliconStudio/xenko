...
namespace LightningsAndLasersTest
{
    [TestFixture]
    public class LightningsAndLasersTest
    {
        private const string Path = "samples\\Particles\\LightningsAndLasers\\Bin\\Windows\\Debug\\LightningsAndLasers.exe";
