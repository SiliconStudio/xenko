...
{
    public class SimpleDirtiableActionItem : DirtiableActionItem
    {
        private static int counter;
        private bool done = true;

        public SimpleDirtiableActionItem(IEnumerable<IDirtiable> dirtiables)
            : base("DirtiableActionItem", dirtiables)
        {
            Counter = ++counter;
        }
