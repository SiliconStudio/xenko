...
namespace SiliconStudio.Presentation.Tests
{
    ...
    class TestObservableSet
    {
        ...
        public void TestAdd()
        {
            ...
            var set = new ObservableSet<string>(list);
            Assert.AreEqual(set.Count, list.Count);
            set.PropertyChanged += (sender, e) => Assert.AreEqual(e.PropertyName, nameof(ObservableSet<string>.Count));
        ...
        public void TestClear()
        {
            ...
            Assert.AreEqual(set.Count, list.Count);
            set.PropertyChanged += (sender, e) => Assert.AreEqual(e.PropertyName, nameof(ObservableSet<string>.Count));
            set.CollectionChanged += (sender, e) => Assert.AreEqual(e.Action, NotifyCollectionChangedAction.Reset);
            set.Clear();
