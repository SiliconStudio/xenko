...
{
    /// <summary>
    /// This interface represents a factory capable of creating <see cref="IGraphNode"/> instances for <see cref="IGraphNode"/> object. An <see cref="IGraphNode"/>
    ...
    public interface IContentFactory
    {
        ...
        IGraphNode CreateObjectContent(INodeBuilder nodeBuilder, Guid guid, object obj, ITypeDescriptor descriptor, bool isPrimitive);
        ...
        IGraphNode CreateBoxedContent(INodeBuilder nodeBuilder, Guid guid, object structure, ITypeDescriptor descriptor, bool isPrimitive);
        ...
        IGraphNode CreateMemberContent(INodeBuilder nodeBuilder, Guid guid, IObjectNode parent, IMemberDescriptor member, bool isPrimitive, object value);
    }
}
