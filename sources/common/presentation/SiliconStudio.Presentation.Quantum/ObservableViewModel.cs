...
namespace SiliconStudio.Presentation.Quantum
{
    ...
    public class ObservableViewModel : DispatcherViewModel
    {
            ...
            : this(serviceProvider)
        {
            ...
            var node = ObservableViewModelService.ObservableNodeFactory(this, "Root", graphNode.IsPrimitive, graphNode, new GraphNodePath(graphNode), graphNode.Type, Index.Empty);
            node.Initialize();
            RootNode = node;
