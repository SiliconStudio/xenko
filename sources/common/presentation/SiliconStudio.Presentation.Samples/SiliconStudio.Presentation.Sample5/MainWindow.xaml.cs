...
using SiliconStudio.Presentation.Dialogs;
...
namespace SiliconStudio.Presentation.Sample
{
    public partial class MainWindow
    {
        public MainWindow()
        {
            ...
            // The dialog service allows to invoke common dialog windows.
            var dialogService = new DialogService(Dispatcher, this);
            // We instantiate a simple view model and set it as data context of this window.
            DataContext = new SimpleViewModel(dispatcherService, dialogService);
        }
    }
}
