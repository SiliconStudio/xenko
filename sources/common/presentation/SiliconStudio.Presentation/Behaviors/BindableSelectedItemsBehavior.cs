...
namespace SiliconStudio.Presentation.Behaviors
{
    ...
    public abstract class BindableSelectedItemsBehavior<T> : Behavior<T> where T : Control
    {
        ...
        {
            BindableSelectedItemsControl.BindingReactivated += () => CollectionSelectionChanged(SelectedItems, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset, null));
        }
