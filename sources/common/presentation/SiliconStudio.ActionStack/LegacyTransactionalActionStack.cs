...
namespace SiliconStudio.ActionStack
{
    ...
    /// </remarks>
    public class LegacyTransactionalActionStack : ActionStack, ITransactionalActionStack
    {
        /// <summary>
        ...
        public LegacyTransactionalActionStack(int capacity)
            : base(capacity)
        {
        }
        ...
        public LegacyTransactionalActionStack(int capacity, IEnumerable<IActionItem> initialActionsItems)
