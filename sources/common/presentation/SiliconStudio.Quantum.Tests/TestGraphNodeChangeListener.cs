...
namespace SiliconStudio.Quantum.Tests
{
    ...
    public class TestGraphNodeChangeListener
    {
        ...
        public void TestChangePrimitiveMember()
        {
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, 3, 4, x => x.Content.Update(4));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member1)]);
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, 4, 5, x => x.Content.Update(5));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member1)]);
        }
        ...
        public void TestChangeReferenceMember()
        {
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, obj[0], obj[1], x => x.Content.Update(obj[1]));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member2)]);
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, obj[1], obj[2], x => x.Content.Update(obj[2]));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member2)]);
        }
        ...
        public void TestChangeStruct()
        {
            ...
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member4)]);
            TestContentChange(listener, node[nameof(Struct.Member1)], ContentChangeType.ValueChange, Index.Empty, "cc", "dd", x => x[nameof(Struct.Member1)].Content.Update("dd"));
        ...
        public void TestChangeStructMember()
        {
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, obj[0], obj[1], x => x.Content.Update(obj[1], Index.Empty));
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, Index.Empty, obj[1], obj[2], x => x.Content.Update(obj[2], Index.Empty));
            // TODO: would be nice to be able to keep the same boxed node!
            //Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member4)]);
            //Assert.AreEqual(node[nameof(Struct.Member1)], rootNode[nameof(ComplexClass.Member4)][nameof(Struct.Member1)]);
        }
        ...
        public void TestChangePrimitiveList()
        {
            ...
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member5)]);
            TestContentChange(listener, node, ContentChangeType.ValueChange, new Index(0), "cc", "dd", x => x.Content.Update("dd", new Index(0)));
        ...
        public void TestChangePrimitiveListItem()
        {
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, new Index(0), obj[0], obj[1], x => x.Content.Update(obj[1], new Index(0)));
            Assert.AreEqual(obj[1], node.Content.Retrieve(new Index(0)));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member5)]);
            TestContentChange(listener, node, ContentChangeType.ValueChange, new Index(0), obj[1], obj[2], x => x.Content.Update(obj[2], new Index(0)));
        ...
        public void TestAddPrimitiveListItem()
        {
            ...
            var node = rootNode[nameof(ComplexClass.Member5)];
            Assert.AreEqual(obj[0], node.Content.Retrieve(new Index(0)));
            TestContentChange(listener, node, ContentChangeType.CollectionAdd, new Index(1), null, obj[1], x => x.Content.Add(obj[1], new Index(1)));
            Assert.AreEqual(obj[1], node.Content.Retrieve(new Index(1)));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member5)]);
            TestContentChange(listener, node, ContentChangeType.CollectionAdd, new Index(2), null, obj[2], x => x.Content.Add(obj[2], new Index(2)));
        ...
        public void TestRemovePrimitiveListItem()
        {
            ...
            Assert.AreEqual(obj[1], node.Content.Retrieve(new Index(1)));
            Assert.AreEqual(obj[2], node.Content.Retrieve(new Index(2)));
            TestContentChange(listener, node, ContentChangeType.CollectionRemove, new Index(1), obj[1], null, x => x.Content.Remove(obj[1], new Index(1)));
            Assert.AreEqual(obj[0], node.Content.Retrieve(new Index(0)));
            Assert.AreEqual(obj[2], node.Content.Retrieve(new Index(1)));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member5)]);
            TestContentChange(listener, node, ContentChangeType.CollectionRemove, new Index(1), obj[2], null, x => x.Content.Remove(obj[2], new Index(1)));
            Assert.AreEqual(obj[0], node.Content.Retrieve(new Index(0)));
            Assert.AreEqual(node, rootNode[nameof(ComplexClass.Member5)]);
        }
        ...
        public void TestChangeReferenceList()
        {
            ...
            TestContentChange(listener, node, ContentChangeType.ValueChange, new Index(0), obj[2][0], newItem, x => x.Content.Update(newItem, new Index(0)));
        ...
        private static void TestContentChange([NotNull] GraphNodeChangeListener listener, IGraphNode contentOwner, ContentChangeType type, Index index, object oldValue, object newValue, [NotNull] Action<IGraphNode> change)
        {
            var i = 0;
