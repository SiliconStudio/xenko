...
namespace SiliconStudio.Translation
{
    ...
    public static class Tr
    {
        ...
        {
            return TranslationManager.Instance.GetString(text);
        }
        ...
        {
            return TranslationManager.Instance.GetPluralString(text, pluralText, n);
        }
        ...
        {
            return TranslationManager.Instance.GetParticularString(context, text);
        }
        ...
        {
            return TranslationManager.Instance.GetParticularPluralString(context, text, textPlural, n);
        }
    }
}
