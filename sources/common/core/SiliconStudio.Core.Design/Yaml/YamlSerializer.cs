...
namespace SiliconStudio.Core.Yaml
{
    ...
    public class YamlSerializer
    {
        ...
        /// <param name="stream">A YAML string from a stream .</param>
        /// <returns>An instance of the YAML data.</returns>
        public IEnumerable<T> DeserializeMultiple<T>(Stream stream, bool generateIds = true)
        {
        ...
        /// <param name="contextSettings">The context settings.</param>
        /// <param name="generateIds"><c>true</c> to generate ~Id for class objects</param>
        public void Serialize(Stream stream, object instance, Type type, SerializerContextSettings contextSettings, bool generateIds = true)
        {
            var serializer = GetYamlSerializer(false);
        ...
        public string Serialize(object instance, Type type, SerializerContextSettings contextSettings, bool generateIds = true)
        {
            var serializer = GetYamlSerializer(false);
        ...
        /// <param name="generateIds"><c>true</c> to generate ~Id for class objects</param>
        /// <returns>a string in YAML format</returns>
        public string Serialize(object instance, bool generateIds = true)
        {
        ...
        private Serializer GetYamlSerializer(bool generateIds = true)
        {
        ...
        private void AssemblyRegistry_AssemblyRegistered(object sender, AssemblyRegisteredEventArgs e)
        {
            lock (Lock)
            {
        ...
        private void AssemblyRegistry_AssemblyUnregistered(object sender, AssemblyRegisteredEventArgs e)
        {
            lock (Lock)
            {
