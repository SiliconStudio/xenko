...
namespace SiliconStudio.Core.Serialization.Assets
{
    ...
    public sealed partial class AssetManager : IAssetManager
    {
        ...
        {
            var errorMessage = $"The asset '{url}' could not be found. Asset path should be 'MyFolder/MyAssetName'. Check that the path is correct and that the asset has been included to the build.";
