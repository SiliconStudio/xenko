...
namespace SiliconStudio.Core.Serialization.Serializers
{
    ...
    public class TupleSerializer<T1> : DataSerializer<Tuple<T1>>
    {
        ...
        /// <inheritdoc />
        public override void Serialize(ref Tuple<T1> obj, ArchiveMode mode, SerializationStream stream)
        {
    ...
    public class TupleSerializer<T1, T2> : DataSerializer<Tuple<T1, T2>>
    {
        ...
        /// <inheritdoc />
        public override void Serialize(ref Tuple<T1, T2> obj, ArchiveMode mode, SerializationStream stream)
        {
            if (mode == ArchiveMode.Serialize)
            {
                item1Serializer.Serialize(obj.Item1, stream);
    ...
    public class TupleSerializer<T1, T2, T3, T4> : DataSerializer<Tuple<T1, T2, T3, T4>>
    {
        ...
        /// <inheritdoc />
        public override void Serialize(ref Tuple<T1, T2, T3, T4> obj, ArchiveMode mode, SerializationStream stream)
        {
            if (mode == ArchiveMode.Serialize)
            {
                item1Serializer.Serialize(obj.Item1, stream);
