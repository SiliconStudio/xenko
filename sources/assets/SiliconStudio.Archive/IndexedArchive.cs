...
{
    class IndexedArchive : IDisposable
    {
        ...
        public void Save(Stream output, IProgress<ProgressReport> progress)
        {
            CheckDisposed();
            ...
            using (var archiveStream = CreateTemporaryStream())
            {
                ...
                CompressionUtility.Compress(archiveStream, output, progress);
            }  // close archiveStream
        }
