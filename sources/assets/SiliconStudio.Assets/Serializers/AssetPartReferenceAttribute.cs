...
namespace SiliconStudio.Assets.Serializers
{
    ...
    /// of a certain type might be the natural containers of part objects of another type. Each type contained in the <see cref="ContainsType"/> collection
    ...
    public class AssetPartReferenceAttribute : Attribute
    {
        ...
        /// <param name="containsType">The collection of asset part types that are naturally contained in the type indicated by <paramref name="referenceableType"/>.</param>
        public AssetPartReferenceAttribute(Type referenceableType, params Type[] containsType)
        {
            ReferenceableType = referenceableType;
            ContainsType = containsType ?? new Type[0];
        }
