...
namespace SiliconStudio.Assets
{
    ...
    public sealed class AssetImportSession
    {
        ...
        private static void MergeAsset(AssetToImportMergeGroup toImport, AssetToImportMerge selectedMerge, Dictionary<Guid, AssetItem> idRemapping)
        {
            ...
            // Set the final item
            toImport.MergedItem = new AssetItem(toImport.SelectedItem.Location, finalAsset) { SourceFolder = toImport.SelectedItem.SourceFolder, ProjectFile = toImport.SelectedItem.ProjectFile };
        }
