...
namespace SiliconStudio.ImageComparerService
{
    ...
    {
        public const string DefaultServiceName = "SiliconStudio Image Comparer Service";
        ...
        protected override void OnStart(string[] args)
        {
            ...
            var showHelp = false;
            baseOutputPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "SiliconStudio", "ImageComparerResults");
            ...
            var p = new OptionSet
                {
                    ...
                    { "o|output=", @"Output folder (default: %APPDATA%\SiliconStudio\ImageComparerResults)", v => baseOutputPath = v },
                };
