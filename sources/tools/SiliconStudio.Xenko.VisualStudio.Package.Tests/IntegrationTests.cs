    ...
    public class IntegrationTests
    {
        ...
        public void Init()
        {
            ...
            dte = context.Execute(() =>
            {
                ...
                else
                {
                    ...
                    psi.EnvironmentVariables["SiliconStudioXenkoDir"] = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\..\..\..");
        ...
        public void TestXkslGeneration()
        {
            ...
            try
            {
                ...
                var newGameFolder = solution.Projects.OfType<Project>().First();
