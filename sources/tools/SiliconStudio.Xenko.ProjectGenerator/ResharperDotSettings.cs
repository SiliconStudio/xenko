...
namespace SiliconStudio.Xenko.ProjectGenerator
{
    ...
    #line 1 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
...
#line hidden
	...
	<s:String x:Key=""/Default/Environment/InjectedLayers/FileInjectedLayer/=");
            ...
            #line 7 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(FileInjectedGuid.ToString("N").ToUpperInvariant()));
            
            #line default
            #line hidden
            this.Write("/AbsolutePath/@EntryValue\">Z:\\InvalidPath\\Xenko.sln.DotSettings</s:String>\r\n\t<s" +
                    ":String x:Key=\"/Default/Environment/InjectedLayers/FileInjectedLayer/=");
            
            #line 8 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(FileInjectedGuid.ToString("N").ToUpperInvariant()));
            ...
            #line 9 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(FileInjectedGuid.ToString("N").ToUpperInvariant()));
            ...
            #line 10 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(FileInjectedGuid.ToString("N").ToUpperInvariant()));
            ...
            #line 11 "C:\Dev\Xenko\sources\tools\SiliconStudio.Xenko.ProjectGenerator\ResharperDotSettings.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(FileInjectedGuid.ToString("N").ToUpperInvariant()));
