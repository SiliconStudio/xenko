...
{
    public class DownloadFileQuery : SocketMessage
    {
        public string Url { get; set; }
    }

    public class FileExistsQuery : SocketMessage
    {
        public string Url { get; set; }
    }

    public class FileExistsAnswer : SocketMessage
    {
        public bool FileExists { get; set; }
    }
    
    public class DownloadFileAnswer : SocketMessage
    {
