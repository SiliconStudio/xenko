...
namespace SiliconStudio.Paradox.Engine.Tests
{
    ...
    public class TesselationTest : EngineTestBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            var sphere = new Entity("Sphere") { new ModelComponent(new ProceduralModelDescriptor(new SphereProceduralModel { Radius = 100, Tessellation = 5, MaterialInstance = { Material = materials[0] }} ).GenerateModel(Services)) };
