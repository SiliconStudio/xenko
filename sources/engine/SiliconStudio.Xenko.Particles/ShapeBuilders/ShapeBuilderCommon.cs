...
namespace SiliconStudio.Xenko.Particles.ShapeBuilders
{
    ...
    {
        /// <inheritdoc />
        public override int BuildVertexBuffer(ref ParticleBufferState bufferState, Vector3 invViewX, Vector3 invViewY, ref Vector3 spaceTranslation, ref Quaternion spaceRotation, float spaceScale, IParticleSortedList sorter)
        {
