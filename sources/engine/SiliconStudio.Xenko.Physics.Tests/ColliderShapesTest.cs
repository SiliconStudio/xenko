    ...
    public class ColliderShapesTest : GameTest
    {
        ...
        public void ColliderShapesTest1()
        {
            ...
            game.Script.AddTask(async () =>
            {
                ...
                Assert.AreEqual(hit.Point, cube.Transform.Position + new Vector3(0.0f, 0.5f, -0.5f));
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, 0.9991773f, -0.04055634f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(2.17587972f, 0.5f, -7.46081161f) - hit.Point).Length(), 0.001f);

                hit = simulation.Raycast((cylinder.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.55f, 0.0f), cylinder.Transform.Position + new Vector3(0.0f, -0.55f, 0.0f));
                Assert.IsFalse(hit.Succeeded);
                hit = simulation.Raycast((cylinder.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.5f, 0.0f), cylinder.Transform.Position + new Vector3(0.0f, -0.5f, 0.0f));
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, -0.9999594f, -0.00901306048f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(2.17587972f, -0.5f, -7.46081161f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0.984618843f, -0.00194456265f, -0.174706012f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(2.67587972f, 0, -7.049136f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, 0.9758787f, -0.218313679f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(0, 1.5999999f, -7.03867149f) - hit.Point).Length(), 0.001f);

                hit = simulation.Raycast((capsule.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.65f, 0.0f), capsule.Transform.Position + new Vector3(0.0f, -0.65f, 0.0f));
                Assert.IsFalse(hit.Succeeded);
                hit = simulation.Raycast((capsule.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.6f, 0.0f), capsule.Transform.Position + new Vector3(0.0f, -0.6f, 0.0f));
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, -0.999195457f, -0.0401064046f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(0, 0.399999917f, -7.007019f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, 0.5078509f, -0.8614451f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(1, 0.5f, -12.04643f) - hit.Point).Length(), 0.001f);

                hit = simulation.Raycast((cone.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.55f, 0.0f), cone.Transform.Position + new Vector3(0.0f, -0.55f, 0.0f));
                Assert.IsFalse(hit.Succeeded);
                hit = simulation.Raycast((cone.Transform.Position - Vector3.UnitZ * 2) + new Vector3(0.0f, -0.5f, 0.0f), cone.Transform.Position + new Vector3(0.0f, -0.5f, 0.0f));
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0, 0, -1) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(1, -0.5f, -12.54f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0.8664685f, 0.4454662f, -0.2253714f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(1.3f, 0, -12.02208f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, -1.146684E-06f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-3.866335f, 1.407022f, -17.4267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, 0f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-3.866335f, -0.5829783f, -17.4267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, 7.166773E-08f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-2.376335f, -0.08297831f, -17.4267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, 0f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-4.366335f, -0.08297831f, -17.4267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(3.12393E-07f, 0f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-3.866335f, 2.897022f, -17.9267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, 0f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-3.866335f, -1.082978f, -17.9267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(0f, 0f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(0.6036654f, -0.08297831f, -17.9267f) - hit.Point).Length(), 0.001f);
                ...
                Assert.IsTrue(hit.Succeeded);
                Assert.AreEqual(0.0f, (new Vector3(-2.861034E-06f, 3.889218E-06f, -1f) - hit.Normal).Length(), 0.001f);
                Assert.AreEqual(0.0f, (new Vector3(-5.366335f, -0.08297831f, -17.9267f) - hit.Point).Length(), 0.001f);
