...
namespace SiliconStudio.Xenko.UI.Controls
{
    ...
    public class ModalElement : ButtonBase
    {
        ...
        /// </summary>
        protected readonly static PropertyKey<bool> IsModalPropertyKey = new PropertyKey<bool>(nameof(IsModalPropertyKey), typeof(ModalElement), DefaultValueMetadata.Static(true));
