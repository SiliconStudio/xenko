...
namespace SiliconStudio.Xenko.UI.Controls
{
    ...
    public class ScrollViewer : ContentControl
    {
        ...
        /// </summary>
        public static readonly PropertyKey<ScrollingMode> ScrollModePropertyKey = DependencyPropertyFactory.Register(nameof(ScrollModePropertyKey), typeof(ScrollViewer), ScrollingMode.Horizontal, InvalidateScrollMode);

        /// <summary>
        /// The key to the Deceleration dependency property.
        /// </summary>
        public static readonly PropertyKey<float> DecelerationPropertyKey = DependencyPropertyFactory.Register(nameof(DecelerationPropertyKey), typeof(ScrollViewer), 1500f, ValidateDecelarationProperty);

        /// <summary>
        /// The key to the TouchScrollingEnabled dependency property.
        /// </summary>
        protected static readonly PropertyKey<bool> TouchScrollingEnabledPropertyKey = DependencyPropertyFactory.Register(nameof(TouchScrollingEnabledPropertyKey), typeof(ScrollViewer), true, TouchScrollingEnabledInvalidationCallback);

        /// <summary>
        /// The key to the ScrollBarColor dependency property.
        /// </summary>
        protected static readonly PropertyKey<Color> ScrollBarColorPropertyKey = DependencyPropertyFactory.Register(nameof(ScrollBarColorPropertyKey), typeof(ScrollViewer), 1f * new Color(0.1f, 0.1f, 0.1f, 1f));

        /// <summary>
        /// The key to the ScrollBarThickness dependency property.
        /// </summary>
        protected static readonly PropertyKey<float> ScrollBarThicknessPropertyKey = DependencyPropertyFactory.Register(nameof(ScrollBarThicknessPropertyKey), typeof(ScrollViewer), 6f);
