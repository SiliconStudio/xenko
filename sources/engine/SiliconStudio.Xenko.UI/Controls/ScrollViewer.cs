...
namespace SiliconStudio.Xenko.UI.Controls
{
    ...
    public class ScrollViewer : ContentControl
    {
        ...
        /// </summary>
        public readonly static PropertyKey<ScrollingMode> ScrollModePropertyKey = new PropertyKey<ScrollingMode>(nameof(ScrollModePropertyKey), typeof(ScrollViewer), DefaultValueMetadata.Static(ScrollingMode.Horizontal), ObjectInvalidationMetadata.New<ScrollingMode>(InvalidateScrollMode));

        /// <summary>
        /// The key to the Deceleration dependency property.
        /// </summary>
        public readonly static PropertyKey<float> DecelerationPropertyKey = new PropertyKey<float>(nameof(DecelerationPropertyKey), typeof(ScrollViewer), DefaultValueMetadata.Static(1500f), ValidateValueMetadata.New<float>(ValidateDecelarationProperty));

        /// <summary>
        /// The key to the TouchScrollingEnabled dependency property.
        /// </summary>
        protected readonly static PropertyKey<bool> TouchScrollingEnabledPropertyKey = new PropertyKey<bool>(nameof(TouchScrollingEnabledPropertyKey), typeof(ScrollViewer), DefaultValueMetadata.Static(true), ObjectInvalidationMetadata.New<bool>(TouchScrollingEnabledInvalidationCallback));

        /// <summary>
        /// The key to the ScrollBarColor dependency property.
        /// </summary>
        protected readonly static PropertyKey<Color> ScrollBarColorPropertyKey = new PropertyKey<Color>(nameof(ScrollBarColorPropertyKey), typeof(ScrollViewer), DefaultValueMetadata.Static(1f * new Color(0.1f, 0.1f, 0.1f, 1f)));

        /// <summary>
        /// The key to the ScrollBarThickness dependency property.
        /// </summary>
        protected readonly static PropertyKey<float> ScrollBarThicknessPropertyKey = new PropertyKey<float>(nameof(ScrollBarThicknessPropertyKey), typeof(ScrollViewer), DefaultValueMetadata.Static(6f));
