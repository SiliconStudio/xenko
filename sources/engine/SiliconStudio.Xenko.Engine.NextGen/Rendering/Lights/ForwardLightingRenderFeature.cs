    ...
    public class ForwardLightingRenderFeature : SubRenderFeature
    {
        ...
        public override void PrepareEffectPermutations()
        {
            ...
            foreach (var objectNodeReference in RootRenderFeature.ObjectNodeReferences)
            {
                ...
                for (int i = 0; i < effectSlotCount; ++i)
                {
                    ...
                    PrepareRenderModelForRendering(renderMesh.RenderModel, out renderObjectInfoData.Data[objectNodeReference.Index], renderEffect, effectSlotCount);

                    renderObjectInfo = renderObjectInfoData[objectNodeReference];
        ...
        public override void Prepare(NextGenRenderContext context)
        {
            ...
            for (int renderNodeIndex = 0; renderNodeIndex < RootRenderFeature.renderNodes.Count; renderNodeIndex++)
            {
                ...
                resourceGroupPool[resourceGroupPoolOffset + perLightingDescriptorSetSlot.Index] = renderObjectInfo.LightShadersPermutation.Info.Resources;
            }
        }
        ...
        private void PrepareRenderModelForRendering(RenderModel model, out RenderModelLights renderObjectInfo, RenderEffect renderEffect, int effectSlot)
        {
            // Already processed?
