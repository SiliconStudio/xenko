...
{
    /// <summary>
    /// A list of <see cref="RenderArchitecture.LightComponentCollection"/> for a particular type of light (direct light, direct light + shadows, environment lights).
    /// </summary>
    [DebuggerDisplay("LightCollections[{Count}]")]
    public sealed class LightComponentCollectionGroup : IEnumerable<RenderArchitecture.LightComponentCollection>
    {
        ...
        private PoolListStruct<RenderArchitecture.LightComponentCollection> lightCollectionPool;
        ...
        {
            lightCollectionPool = new PoolListStruct<RenderArchitecture.LightComponentCollection>(32, LightComponentCollectionFactory);
        ...
        /// <summary>
        /// Gets the <see cref="RenderArchitecture.LightComponentCollection"/> at the specified index.
        /// </summary>
        ...
        public RenderArchitecture.LightComponentCollection this[int index]
        {
            get
            {
        ...
        /// <returns>LightComponentCollection.</returns>
        public RenderArchitecture.LightComponentCollection FindLightCollectionByGroup(EntityGroup group)
        {
        ...
        /// <summary>
        /// Gets the number of <see cref="RenderArchitecture.LightComponentCollection"/> stored in this group.
        /// </summary>
        /// <value>The number of <see cref="RenderArchitecture.LightComponentCollection"/> stored in this group.</value>
        public int Count
        {
            get
            {
        ...
        public FastListStruct<RenderArchitecture.LightComponentCollection>.Enumerator GetEnumerator()
        {
            return lightCollectionPool.GetEnumerator();
        }

        IEnumerator<RenderArchitecture.LightComponentCollection> IEnumerable<RenderArchitecture.LightComponentCollection>.GetEnumerator()
        {
            return lightCollectionPool.GetEnumerator();
        }
        ...
        private static RenderArchitecture.LightComponentCollection LightComponentCollectionFactory()
        {
            return new RenderArchitecture.LightComponentCollection();
        }
    }
}