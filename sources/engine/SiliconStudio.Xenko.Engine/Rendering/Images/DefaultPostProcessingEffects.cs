...
namespace SiliconStudio.Xenko.Rendering.Images
{
    ...
    public sealed class PostProcessingEffects : BasePostProcessingEffects, IImageEffectRenderer, ISharedRenderer
    {
        ...
        public override void Draw(RenderDrawContext drawContext, List<Texture> inputTargets, Texture inputDepthStencil, Texture outputTarget)
        {
