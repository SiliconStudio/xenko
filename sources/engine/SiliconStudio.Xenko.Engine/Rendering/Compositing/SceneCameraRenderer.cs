...
namespace SiliconStudio.Xenko.Rendering.Compositing
{
    ...
    public partial class SceneCameraRenderer : SceneRendererBase
    {
        ...
        protected virtual CameraComponent ResolveCamera(RenderContext renderContext)
        {
            ...
            if (camera == null) throw new InvalidOperationException($"A {nameof(SceneCameraRenderer)} in use has not camera set. Make sure the camera component to use has its [{nameof(CameraComponent.Slot)}] property correctly set.");
            return camera;
        }
