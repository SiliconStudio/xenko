...
namespace SiliconStudio.Xenko.Rendering.Materials
{
    ...
    public class MaterialNormalMapFeature : MaterialFeature, IMaterialSurfaceFeature, IMaterialStreamProvider
    {
        ...
        /// <summary>
        /// Indicating wether the Y-component of normals should be inverted, to compensate for a flipped tanget-space.
        /// </summary>
        /// <userdoc>
        /// Needs to be enabled, when a normal with positive Y-component (green) is supposed to face up instead of down. This is necessary for normal maps generated by tools, which assume flipped texture coordinates.
        /// </userdoc>
        [DataMember(40)]
        [DefaultValue(true)]
        [Display("Invert Y")]
