...
namespace SiliconStudio.Paradox.Graphics.GeometricPrimitives
{
    public partial class GeometricPrimitive
    {
        ...
        public static class Cone
        {
            ...
            public static GeometricPrimitive New(GraphicsDevice device, float radius = 0.5f, float height = 1.0f, int tessellation = 16, bool toLeftHanded = false)
            {
                // Create the primitive object.
                return new GeometricPrimitive(device, New(radius, height, tessellation, toLeftHanded));
            }
