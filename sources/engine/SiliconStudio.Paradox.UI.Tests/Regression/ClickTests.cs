...
namespace SiliconStudio.Paradox.UI.Tests.Regression
{
    ...
    public class ClickTests : UnitTestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            var element1 = new Button { Name = "1", Width = 800, Height = 400, Content = new TextBlock { Font = Asset.Load<SpriteFont>("CourierNew12") } };
            ...
            var element2 = new Button { Name = "2", Width = 400, Height = 200, Content = new TextBlock { Font = Asset.Load<SpriteFont>("CourierNew12") } };
            ...
            var element3 = new Button { Name = "3", Width = 400, Height = 200, Content = new TextBlock { Font = Asset.Load<SpriteFont>("CourierNew12") } };
            ...
            var element4 = new Button { Name = "4", Width = 400, Height = 200, Content = new TextBlock { Font = Asset.Load<SpriteFont>("CourierNew12") } };
        ...
        protected override void RegisterTests()
        {
            ...
            FrameGameSystem.Draw(3, () => SetElement2Matrix(Matrix.Translation(0, 0, 100))).Draw(4, Draw3).TakeScreenshot(4);
            FrameGameSystem.Draw(5, () => SetElement2Matrix(Matrix.Translation(0, 0, -100))).Draw(6, Draw4).TakeScreenshot(6);
