...
namespace SiliconStudio.Paradox.UI.Tests.Regression
{
    ...
    public class CanvasGridTest : UnitTestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            // left/top
            var image1 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            // right/top
            var image2 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            // left/bottom
            var image3 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            // 1/3 right/bottom
            var image4 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            var image5 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            var image6 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            var image7 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
            ...
            var image8 = new ImageElement { Source = new UIImage(Asset.Load<Texture2D>("uv")), StretchType = StretchType.FillOnStretch };
