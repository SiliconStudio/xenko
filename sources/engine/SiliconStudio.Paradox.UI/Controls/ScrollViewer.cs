...
namespace SiliconStudio.Paradox.UI.Controls
{
    ...
    public class ScrollViewer : ContentControl
    {
        ...
        /// <summary>
        /// The key to the ScrollMode dependency property.
        /// </summary>
        public readonly static PropertyKey<ScrollingMode> ScrollModePropertyKey = new PropertyKey<ScrollingMode>("ScrollModeKey", typeof(ScrollViewer), DefaultValueMetadata.Static(ScrollingMode.Horizontal), ObjectInvalidationMetadata.New<ScrollingMode>(InvalidateScrollMode));

        /// <summary>
        /// The key to the Deceleration dependency property.
        /// </summary>
        public readonly static PropertyKey<float> DecelerationPropertyKey = new PropertyKey<float>("DecelerationKey", typeof(ScrollViewer), DefaultValueMetadata.Static(1500f), ValidateValueMetadata.New<float>(ValidateDecelarationProperty));

        /// <summary>
        /// The key to the TouchScrollingEnabled dependency property.
        /// </summary>
        protected readonly static PropertyKey<bool> TouchScrollingEnabledPropertyKey = new PropertyKey<bool>("TouchScrollingEnabledKey", typeof(ScrollViewer), DefaultValueMetadata.Static(true), ObjectInvalidationMetadata.New<bool>(TouchScrollingEnabledInvalidationCallback));

        /// <summary>
        /// The key to the ScrollBarColor dependency property.
        /// </summary>
        protected readonly static PropertyKey<Color> ScrollBarColorPropertyKey = new PropertyKey<Color>("ScrollBarColorKey", typeof(ScrollViewer), DefaultValueMetadata.Static(1f * new Color(0.1f, 0.1f, 0.1f, 1f)));

        /// <summary>
        /// The key to the ScrollBarThickness dependency property.
        /// </summary>
        protected readonly static PropertyKey<float> ScrollBarThicknessPropertyKey = new PropertyKey<float>("ScrollBarThicknessKey", typeof(ScrollViewer), DefaultValueMetadata.Static(6f));
        ...
        private static void ValidateDecelarationProperty(ref float value)
        {
            if (float.IsNaN(value))
                throw new ArgumentException("The deceleration must be a valid number. [Deceleration=" + value + "]");
        }
        ...
        internal protected void HideScrollBars()
        {
        ...
        private static void TouchScrollingEnabledInvalidationCallback(object propertyOwner, PropertyKey<bool> propertyKey, bool propertyOldValue)
        {
            var viewer = (ScrollViewer)propertyOwner;
            viewer.OnTouchScrollingEnabledChanged();
        }
        ...
        public ScrollingMode ScrollMode
        {
            ...
            set { DependencyProperties.Set(ScrollModePropertyKey, value); }
        }
        ...
        public float Deceleration
        {
            ...
            set { DependencyProperties.Set(DecelerationPropertyKey, value); }
        }
        ...
        public bool TouchScrollingEnabled
        {
            ...
            set { DependencyProperties.Set(TouchScrollingEnabledPropertyKey, value); }
        }
        ...
        public Color ScrollBarColor
        {
            ...
            set { DependencyProperties.Set(ScrollBarColorPropertyKey, value); }
        }
        ...
        public float ScrollBarThickness
        {
            ...
            set { DependencyProperties.Set(ScrollBarThicknessPropertyKey, value); }
        }
        ...
        private void UpdateVisualContentArrangeMatrix()
        {
            ...
            var childOffsets = offsets + new Vector3(Padding.Left, Padding.Top, Padding.Back) - ViewPort / 2;
