...
{
    /// <summary>
    /// Base class for a constant value for <see cref="IMaterialComputeColor"/>.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class MaterialConstantComputeColor<T> : MaterialComputeColorBase, IMaterialValueComputeColor
    {
        private T value;

        /// <summary>
        /// Initializes a new instance of the <see cref="MaterialConstantComputeColor{T}"/> class.
        /// </summary>
        protected MaterialConstantComputeColor()
        {
            AutoAssignKey = true;
        }
        ...
        protected MaterialConstantComputeColor(T value) : this()
        {
            Value = value;
        }
