...
namespace SiliconStudio.Xenko.Input.Gestures
{
    ...
    /// </summary>
    public sealed class CompositeEventArgs : PointerGestureEventArgs
    {
        public CompositeEventArgs(IPointerDevice pointerDevice, PointerGestureEventType eventType, TimeSpan deltaTime, TimeSpan totalTime, float deltaAngle, float totalAngle, 
