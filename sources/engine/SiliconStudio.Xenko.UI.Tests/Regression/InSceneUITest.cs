...
namespace SiliconStudio.Xenko.UI.Tests.Regression
{
    ...
    public class InSceneUITest : UITestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            var textBlockZ0 = new TextBlock { Font = font, TextColor = Color.Black, TextSize = 15, Text = "At depth 0", VerticalAlignment = VerticalAlignment.Center, SynchronousCharacterGeneration = true, BackgroundColor = Color.Red };
            ...
            var textBlockZ500 = new TextBlock { Font = font, TextColor = Color.Black, TextSize = 15, Text = "At depth 300", VerticalAlignment = VerticalAlignment.Center, SynchronousCharacterGeneration = true, BackgroundColor = Color.Red };
            ...
            var textBlockZM500 = new TextBlock { Font = font, TextColor = Color.Black, TextSize = 15, Text = "At depth -300", VerticalAlignment = VerticalAlignment.Center, SynchronousCharacterGeneration = true, BackgroundColor = Color.Red };
