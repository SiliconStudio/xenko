...
* [API Reference](http://doc.xenko.com/1.4/api/SiliconStudio.Assets.html)
* [Documentation](http://doc.xenko.com/latest)

## Assemblies

[Assembly diagram](http://doc.xenko.com/1.4/manual/engine/assemblies-diagrams.html)

* [__SiliconStudio.Xenko.Graphics__](http://doc.xenko.com/1.4/manual/graphics/index.html):
...
* [__SiliconStudio.Xenko.Input__](http://doc.xenko.com/1.4/manual/input/index.html):
...
* [__SiliconStudio.Xenko.UI__](http://doc.xenko.com/1.4/manual/ui/index.html):
   In-game UI library, similar to WPF (including many UI Controls).
* [__SiliconStudio.Xenko.Shaders__](http://doc.xenko.com/1.4/manual/graphics/graphics-reference/effects-and-shaders-reference/shading-language/index.html):
   Xenko shader language, including many new language constructs to make shader programming much more easy/modular.
* [__SiliconStudio.Xenko.Audio__](http://doc.xenko.com/1.4/manual/audio/index.html):
